...
function loadMarketplaceModelToCotizador(itemId) {
  ...
  // Redirect to Cotizador view via SPA router hash change
  window.location.hash = '#cotizador';

  // Highlight dropzone temporarily
  setTimeout(() => {
...
// --- SPA Page Router ---
const pageIds = ['inicio', 'cotizador', 'galeria', 'marketplace', 'materiales', 'faq'];
...
function navigateToPage(pageId) {
  ...
  // Trigger Three.js canvas container resize update
  if (pageId === 'cotizador') {
    setTimeout(() => {
